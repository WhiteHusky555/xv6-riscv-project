...
countfree()
{
  // Используем твой кастомный системный вызов для мгновенного получения памяти!
  // getfreemem() возвращает размер в байтах, поэтому делим на PGSIZE (4096)
  return getfreemem() / 4096;
}
